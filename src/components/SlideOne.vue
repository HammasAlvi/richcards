        ...
        <div class="slider">
            <div class="mega-slide" :style="{ transform: `translateX(-${currentIndex * 100}%)` }">
                <div class="slide-cont" v-for="(slide, slideIndex) in slides" :key="slideIndex">
                    <div class="slides" v-for="(article, index) in slide" :key="index">
                        <img :src="article.image" :alt="article.alt" />
                        <div class="credit-info">
                            <h2>{{ article.category }}</h2>
                            <h1>{{ article.title }}</h1>
                            <p>{{ article.description }}</p>
                            <button @click="readArticle(article.link)">Read Article</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            slides: [
                [
                    ...
                    },
                    {
                        ...
                        description: 'The Miami Grand Prix is returning, and Chase is giving Sapphire Reserve cardmembers a chance to enjoy exclusive perks at the track.',
                        link: '#'
                    },
                    {
                        image: chicago,
                        ...
                        description: 'EEEEEATSCON Chicago is coming soon, with presale tickets available through May 15, 2024. This edition looks exciting!',
                        link: '#'
                    },
                ],
                [
                    {
                        ...
                        category: 'Credit Card Advice',
                        title: 'The Ultimate Bilt Rent Day Guide – May ...',
                        description: 'Eligible Citi cardholders can now transfer their Citi ThankYou Points to Accor and receive 50% bonus points for a limited time.',
                        link: '#'
                    },
                    {
                        image: women,
                        ...
                        description: 'Chase and IHG have new limited-time offers on the IHG One Rewards credit cards. Here’s how to earn those bonuses.',
                        link: '#'
                    },
                    {
                        image: chicago,
                        ...
                        category: 'Credit Card News',
                        title: 'EEEEEATSCON Chicago Presale Tix ...',
                        description: 'The latest edition of Chase Sapphire’s EEEEEATSCON LA is here. Find out all about the upcoming food festival right here:',
                        link: '#'
                    },
                ],
            ]
